package com.blank.common.mybatis.toolkit;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.core.util.StrUtil;
import com.blank.common.mybatis.toolkit.reflect.GenericTypeUtils;
...
public final class ReflectionKit {
    ...
    public static Object getFieldValue(Object entity, String fieldName) {
        ...
        try {
            ...
            throw new RuntimeException(StrUtil.format("Error: Cannot read field in %s.  Cause:", e, cls.getSimpleName()));
        }
    }
    ...
    public static Map<String, Field> getFieldMap(Class<?> clazz) {
        ...
        return CollUtil.isNotEmpty(fieldList) ? fieldList.stream().collect(Collectors.toMap(Field::getName, Function.identity())) : Collections.emptyMap();
    }
    ...
    public static <T extends AccessibleObject> T setAccessible(T object) {
        return ReflectUtil.setAccessible(object);
    }
